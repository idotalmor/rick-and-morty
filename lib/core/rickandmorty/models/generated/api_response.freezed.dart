...
class _$ApiResponseImpl<T> implements _ApiResponse<T> {
  _$ApiResponseImpl({required this.info, required final List<T> results})
      : _results = results;
  ...
  @override
  String toString() {
    return 'ApiResponse<$T>(info: $info, results: $results)';
  }
...
class _$InfoImpl implements _Info {
  _$InfoImpl({required this.count, required this.pages, this.next, this.prev});
